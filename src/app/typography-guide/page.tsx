    ...
    return (
        <div className="max-w-3xl mx-auto py-20 px-8 space-y-12">
            <header className="space-y-4">
                ...
                <p className="text-xl font-sans text-muted">A verification page for the Anakhe design system.</p>
            </header>

            <section className="space-y-8">
                <div className="space-y-2">
                    <p className="font-sans text-sm text-muted uppercase tracking-wider">Headings (Cormorant Garamond)</p>
                ...
                <div className="space-y-4">
                    <p className="font-sans text-sm text-muted uppercase tracking-wider">Body Text (Lato)</p>
                    <div className="space-y-4 max-w-xl">
                        ...
                        <p className="font-sans text-base font-bold leading-relaxed">
                            <strong>Body Bold (700):</strong> Important emphasis looks like this. We use 700 weight for strong emphasis because 500 is not available in the Lato font family on Google Fonts.
                        </p>
                    </div>
                </div>

                <div className="space-y-4">
                    <p className="font-sans text-sm text-muted uppercase tracking-wider">Selection Test</p>
